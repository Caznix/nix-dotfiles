...
#          "custom/icon" = {
#            format = " ";
#            on-click = "${config.ch.wlogout.logoutlaunch}/bin/logoutlaunch";
#          };
         ...
         "custom/wallchange" = {
           ...
           on-click = "${flake-self.inputs.wall-utils.packages.${pkgs.system}.wall-utils}/bin/wall-utils next";
           on-click-right = "${flake-self.inputs.wall-utils.packages.${pkgs.system}.wall-utils}/bin/wall-utils previous";
           on-click-middle = "${flake-self.inputs.wall-utils.packages.${pkgs.system}.wall-utils}/bin/wall-utils select";
